...
var cameoTable = {
  ...
  "02":  "APPEAL",
  "020": "Appeal (general)",
  "021": "Appeal for material cooperation (general)",
  ...
  "024": "Appeal for political reform (general)",
  ...
  "030": "Express intent to cooperate (general)",
  ...
  "033": "Express intent to provide matyerial aid (general)",
  ...
  "034": "Express intent to institute political reform (general)",
  ...
  "035": "Express intent to yield (general)",
  ...
  "08":  "YIELD",
  "080": "Yield (general) ",
  "081": "Ease administrative sanctions (general)",
  ...
  "104": "Demand political reform (general)",
  ...
  "122": "Reject request or demand for material aid (general)",
  ...
  "123": "Reject request or demand for political reform (general)",
  ...
  "131": "Threaten non-force (general)",
  ...
  "132": "Threaten with administrative sanctions (general)",
  ...
  "138": "Threaten to use military force (general)",
  ...
  "139": "Give ultimatum",
  "14":  "PROTEST",
  "140": "Engage in political dissent (general)",
  ...
  "142": "Conduct hunger strike (general)",
  ...
  "143": "Conduct strike or boycott (general)",
  ...
  "18":  "ASSAULT",
  "180": "Use unconventional violence (general)",
  "181": "Abduct, hijack, or take hostage ",
  "182": "Physically assault (general)",
  ...
  "186": "Assassinate ",
  "19":  "FIGHT",
  "190": "Use conventional military force (general)",
  ...
  "200": "Use unconventional mass violence (general)",
  "201": "Engage in mass expulsion",
  "202": "Engage in mass killings",
  "203": "Engage in ethnic cleansing",
  "204": "Use weapons of mass destruction (general)",
...
module.exports = {
  ...
  getCameoDescription: function(ccode) {
    if (cameoTable[ccode])
      return cameoTable[ccode];
    else  
      return "Description not available for code: " + ccode;
  },

  getEventHtml: function(eventData) {

    var codeAndDescription = eventData.EventCode + ":  " +
      this.getCameoDescription(eventData.EventCode);

    var srcLink = "<a target='_blank' href='" + eventData.SOURCEURL
                  + "'</a>";
    ...
    var retobj = { 
        ...
        actionGeo_ADM1Code: eventData.ActionGeo_ADM1Code,
        actionGeo_CountryCode: eventData.ActionGeo_CountryCode,
        actionGeo_FeatureID: eventData.ActionGeo_FeatureID,
        actionGeo_FullName: eventData.ActionGeo_FullName,
        actionGeo_Lat: eventData.ActionGeo_Lat,
        actionGeo_Long: eventData.ActionGeo_Long,
        actionGeo_Type: eventData.ActionGeo_Type,
        actor1Code: eventData.Actor1Code,
        actor1CountryCode: eventData.Actor1CountryCode,
        actor1EthnicCode: eventData.Actor1EthnicCode,
        actor1Geo_ADM1Code: eventData.Actor1Geo_ADM1Code,
        actor1Geo_CountryCode: eventData.Actor1Geo_CountryCode,
        actor1Geo_FeatureID: eventData.Actor1Geo_FeatureID,
        actor1Geo_FullName: eventData.Actor1Geo_FullName,
        actor1Geo_Lat: eventData.Actor1Geo_Lat,
        actor1Geo_Long: eventData.Actor1Geo_Long,
        actor1Geo_Type: eventData.Actor1Geo_Type,
        actor1KnownGroupCode: eventData.Actor1KnownGroupCode,
        actor1Name: eventData.Actor1Name,
        actor1Religion1Code: eventData.Actor1Religion1Code,
        actor1Religion2Code: eventData.Actor1Religion2Code,
        actor1Type1Code: eventData.Actor1Type1Code,
        actor1Type2Code: eventData.Actor1Type2Code,
        actor1Type3Code: eventData.Actor1Type3Code,
        actor2Code: eventData.Actor2Code,
        actor2CountryCode: eventData.Actor2CountryCode,
        actor2EthnicCode: eventData.Actor2EthnicCode,
        actor2Geo_ADM1Code: eventData.Actor2Geo_ADM1Code,
        actor2Geo_CountryCode: eventData.Actor2Geo_CountryCode,
        actor2Geo_FeatureID: eventData.Actor2Geo_FeatureID,
        actor2Geo_FullName: eventData.Actor2Geo_FullName,
        actor2Geo_Lat: eventData.Actor2Geo_Lat,
        actor2Geo_Long: eventData.Actor2Geo_Long,
        actor2Geo_Type: eventData.Actor2Geo_Type,
        actor2KnownGroupCode: eventData.Actor2KnownGroupCode,
        actor2Name: eventData.Actor2Name,
        actor2Religion1Code: eventData.Actor2Religion1Code,
        actor2Religion2Code: eventData.Actor2Religion2Code,
        actor2Type1Code: eventData.Actor2Type1Code,
        actor2Type2Code: eventData.Actor2Type2Code,
        actor2Type3Code: eventData.Actor2Type3Code,
        avgTone: eventData.AvgTone,
        dateAdded: eventData.DATEADDED,
        eventBaseCode: eventData.EventBaseCode,
        eventCode: eventData.EventCode,
        eventRootCode: eventData.EventRootCode,
        fractionDate: eventData.FractionDate,
        globalEventId: eventData.GLOBALEVENTID,
        goldsteinScale: eventData.GoldsteinScale,
        isRootEvent: eventData.IsRootEvent,
        monthYear: eventData.MonthYear,
        numArticles: eventData.NumArticles,
        numMentions: eventData.NumMentions,
        numSources: eventData.NumSources,
        quadClass: eventData.QuadClass,
        sourceUrl: eventData.SOURCEURL,
        sqldate: eventData.SQLDATE,
        year: eventData.Year
    }

    // Dont want to print a bunch of nulls
